...
export async function bootstrapSeedIfEmpty(): Promise<boolean> {
  ...
  await db.insert(products).values([
    { supplierId: S(1), name: 'Copper Cathode', category: 'Metals & Minerals', description: 'LME Grade A, 99.99% purity, bundled.', spec: ['Purity: 99.99%', 'Grade: LME A', 'Packaging: Bundles ~2.5 MT'], price: '8742', unit: 'MT', moq: '25', originCountry: 'China', purityGrade: '99.99%', verified: true, imageKey: '/products/copper-cathode.jpg' },
    { supplierId: S(2), name: 'Steel Coil Cold Rolled', category: 'Steel', description: 'DC01 cold rolled coil, EN 10130.', spec: ['Standard: EN 10130', 'Thickness: 0.4-2.0 mm'], price: '617', unit: 'MT', moq: '20', originCountry: 'Türkiye', verified: true, imageKey: '/products/steel-coil.jpg' },
    { supplierId: S(3), name: 'Antimony Ore', category: 'Metals & Minerals', description: 'Lump ore, 50-60% Sb content.', spec: ['Sb content: 50-60%', 'Form: Lump ore'], price: '14500', unit: 'MT', moq: '50', originCountry: 'China', purityGrade: '50-60%', verified: true, imageKey: '/products/antimony-ore.jpg' },
    { supplierId: S(4), name: 'Lithium Carbonate', category: 'Chemicals', description: 'Battery grade, 99.5% min.', spec: ['Purity: ≥99.5%', 'Grade: Battery'], price: '18850', unit: 'MT', moq: '1', originCountry: 'China', purityGrade: '99.5%', verified: true, imageKey: '/products/lithium-carbonate.jpg' },
    { supplierId: S(0), name: 'Industrial Pump', category: 'Industrial Equipment', description: 'High efficiency centrifugal pump.', spec: ['Efficiency: IE4', 'Material: SS316'], price: '2450', unit: 'Set', moq: '5', originCountry: 'Türkiye', verified: true, imageKey: '/products/industrial-pump.jpg' },
    { supplierId: S(6), name: 'CNC Machining Center', category: 'Machinery', description: '5-axis machining center, 20k rpm.', spec: ['Axes: 5', 'Spindle: 20,000 rpm'], price: '28000', unit: 'Set', moq: '1', originCountry: 'Germany', verified: true, imageKey: '/products/cnc-machine.jpg' },
    { supplierId: S(3), name: 'Solar Panel 550W', category: 'Renewable Energy', description: 'Mono PERC half-cut, 550W.', spec: ['Cell: Mono PERC', 'Power: 550W'], price: '0.21', unit: 'Watt', moq: '1000', originCountry: 'China', verified: true, imageKey: '/products/solar-panel.jpg' },
    { supplierId: S(7), name: 'Aluminum Ingot', category: 'Metals & Minerals', description: '99.7% primary aluminum ingot, 20kg.', spec: ['Purity: 99.7%', 'Ingot: 20 kg'], price: '2980', unit: 'MT', moq: '25', originCountry: 'Türkiye', purityGrade: '99.7%', verified: true, imageKey: '/products/aluminum-ingot.jpg' },
  ]);
