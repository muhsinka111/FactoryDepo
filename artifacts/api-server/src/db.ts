 ...
 */
import { createDb, users, suppliers, products, rfqs, quotes } from '@workspace/db';
...
export { users, suppliers, products, rfqs, quotes };

/** Convenience namespace for call sites that prefer a grouped import. */
export const tables = { users, suppliers, products, rfqs, quotes };
